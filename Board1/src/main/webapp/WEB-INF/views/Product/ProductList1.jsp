        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" alt="" src="C:\ProjectPicture\Tent1.jpg" /></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">차박용 일반 텐트</a>
                </h4>
                <h5>48900won</h5>
                <p class="card-text"> 보다 안정적인 텐트를 원한다면 클릭! </p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" alt="" src="C:\ProjectPicture\Tent2.jpg" ></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">차박용 도킹 텐트</a>
                </h4>
                <h5>58900won</h5>
                <p class="card-text">보다 자유로운 캠핑을 원한다면 클릭!</p>
              </div>
              <div class="card-footer">
                <small class="text-muted">★ ★ ★ ★ ★ </small>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" alt="" src="C:\ProjectPicture\Tent3.jpg"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">차박용 V2 텐트</a>
                </h4>
                <h5>42900won</h5>
                <p class="card-text">보다 특색있는 텐트를 원한다면 클릭!</p>
              </div>
              <div class="card-footer">
                <small class="text-muted">★ ★ ★ ★ ★ </small>
              </div>
