...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" aria-expanded="true"
				aria-controls="collapseTwo" href="#" data-toggle="collapse"
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" aria-expanded="true"
				aria-controls="collapseUtilities" href="#" data-toggle="collapse"
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" aria-expanded="true"
				aria-controls="collapsePages" href="#" data-toggle="collapse"
          ...
          <form
            ...
            <div class="input-group">
              <input class="form-control bg-light border-0 small"
								aria-describedby="basic-addon2" aria-label="Search" type="text"
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" id="userDropdown"
							...
							data-toggle="dropdown">
                <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">Valerie Luna</span>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">Earnings (Monthly)</div>
                      <div
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div
												class="h5 mb-0 font-weight-bold text-gray-800">$215,000</div>
                    </div>
                    <div class="col-auto">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div
														class="h5 mb-0 mr-3 font-weight-bold text-gray-800">50%</div>
                        </div>
                        <div class="col">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <canvas width="37" height="120"
											class="chartjs-render-monitor" id="myAreaChart"
											style="width: 50px; height: 160px; display: block;"></canvas>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    ...
                    <canvas width="37" height="156"
											class="chartjs-render-monitor" id="myPieChart"
											style="width: 50px; height: 208px; display: block;"></canvas>
                  </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <p>Add some quality, svg illustrations to your project courtesy of <a
											href="https://undraw.co/" target="_blank" rel="nofollow">unDraw</a>, a constantly updated collection of beautiful svg images that you can use completely free and without attribution!</p>
                  <a href="https://undraw.co/" target="_blank"
										rel="nofollow">Browse Illustrations on unDraw →</a>
                </div>
              </div>
  ...
  <!-- Logout Modal-->
  <div tabindex="-1" class="modal fade" id="logoutModal" role="dialog"
...
<script id="dsq-count-scr" src="//startbootstrap.disqus.com/count.js"
	...
	<script
		...
		crossorigin="anonymous"
		integrity="sha384-zDnhMsjVZfS3hiP7oCBRmfjkQC4fzxVxFhBx8Hkz2aZX8gEvA/jsP3eXRCvzTofP"></script>
	<script
	...
	<iframe title="Twitter settings iframe"
		src="https://platform.twitter.com/widgets/widget_iframe.2a008290075125adde2d7b849b06a0bb.html?origin=https%3A%2F%2Fstartbootstrap.com"
		frameborder="0" scrolling="no" style="display: none;"
