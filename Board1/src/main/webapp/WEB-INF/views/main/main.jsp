...
<header class="nav-down responsive-nav hidden-lg hidden-md">
            ...
            <div class="collapse navbar-collapse" id="main-nav">
                <nav>
                    <ul class="nav navbar-nav">
                        <li><a class="active-section" href="#top">Home</a></li>
        ...
        <div class="sidebar-navigation hidde-sm hidden-xs">
            ...
            <nav>
                <ul>
                    <li>
                        <a class="active-section" href="#top">
        ...
        <div class="slider">
            <div class="Modern-Slider content-section slick-initialized slick-slider slick-dotted" id="top" role="toolbar"><button class="PrevArrow slick-arrow" style="display: block;"></button>
                <!-- Item -->
                <div class="slick-list" aria-live="polite"><div class="slick-track" role="listbox" style="width: 3570px; opacity: 1;"><div tabindex="-1" class="item item-1 slick-slide" role="option" aria-hidden="true" aria-describedby="slick-slide00" style="transition:opacity 1000ms linear; left: 0px; top: 0px; width: 1190px; position: relative; z-index: 998; opacity: 0;" data-slick-index="0">
                    <div class="img-fill">
                    <div class="image"></div>
                    <div class="info">
                        <div>
                          ...
                          <p>This is a HTML CSS template provided by 
                          			<a tabindex="-1" href="https://plus.google.com/+templatemo" target="_blank">templatemo</a> website.<br>
                          			Please tell your friends about our site.</p>
                          <div class="white-button button">
                              <a tabindex="-1" href="#featured">Discover More</a>
                          </div>
                        </div>
                        </div>
                    </div>
                </div><div tabindex="-1" class="item item-2 slick-slide slick-current slick-active" role="option" aria-hidden="false" aria-describedby="slick-slide01" style="left: -1190px; top: 0px; width: 1190px; position: relative; z-index: 999; opacity: 1;" data-slick-index="1">
                    <div class="img-fill">
                        <div class="image"></div>
                        <div class="info">
                        <div>
                          ...
                          <div class="white-button button">
                              <a tabindex="0" href="#featured">Discover More</a>
                          </div>
                        </div>
                        </div>
                    </div>
                </div><div tabindex="-1" class="item item-3 slick-slide" role="option" aria-hidden="true" aria-describedby="slick-slide02" style="transition:opacity 1000ms linear; left: -2380px; top: 0px; width: 1190px; position: relative; z-index: 998; opacity: 0;" data-slick-index="2">
                    <div class="img-fill">
                        <div class="image"></div>
                        <div class="info">
                        <div>
                ...
                <!-- // Item -->
            <button class="NextArrow slick-arrow" style="display: inline-block;"></button><ul class="slick-dots" role="tablist" style="display: block;"><li id="slick-slide00" role="presentation" aria-hidden="true" aria-selected="true" aria-controls="navigation00"><button tabindex="0" role="button" type="button" data-role="none">1</button></li><li class="slick-active" id="slick-slide01" role="presentation" aria-hidden="false" aria-selected="false" aria-controls="navigation01"><button tabindex="0" role="button" type="button" data-role="none">2</button></li><li id="slick-slide02" role="presentation" aria-hidden="true" aria-selected="false" aria-controls="navigation02"><button tabindex="0" role="button" type="button" data-role="none">3</button></li></ul></div>
        </div>
        ...
        <div class="page-content">
            <section class="content-section" id="featured">
                ...
                <div class="section-content">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transition:all; width: 2496px; transform: translate3d(0px, 0px, 0px);"><div class="owl-item active" style="width: 247.33px; margin-right: 30px;"><div class="item">
                            <div class="image">
                                <img alt="" src="img/featured_1.jpg">
                        ...
                        </div></div><div class="owl-item active" style="width: 247.33px; margin-right: 30px;"><div class="item">
                            <div class="image">
                                <img alt="" src="img/featured_2.jpg">
                                <div class="featured-button button">
                                    <a href="#projects">Continue Reading</a>
                                </div>
                            </div>
                            ...
                            <div class="image">
                                <img alt="" src="img/featured_3.jpg">
                                <div class="featured-button button">
                                    <a href="#projects">Continue Reading</a>
                                </div>
                            </div>
                        ...
                        </div></div><div class="owl-item" style="width: 247.33px; margin-right: 30px;"><div class="item">
                            <div class="image">
                                <img alt="" src="img/featured_1.jpg">
                                <div class="featured-button button">
                                    <a href="#projects">Continue Reading</a>
                        ...
                        </div></div></div></div><div class="owl-nav"><button class="owl-prev disabled" role="presentation"><span aria-label="prev">‹</span></button><button class="owl-next" role="presentation"><span aria-label="next">›</span></button></div><div class="owl-dots"><button class="owl-dot active"><span></span></button><button class="owl-dot"><span></span></button><button class="owl-dot"><span></span></button></div></div>
                </div>
            </section>
                ...
                <div class="section-content">
                    <div class="masonry">
                        <div class="row">
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="img/portfolio_big_1.jpg" data-lightbox="image"><img alt="image 1" src="img/portfolio_1.jpg"></a>
                                </div>
                            </div>
                            <div class="item second-item">
                                <div class="col-md-4">
                                    <a href="img/portfolio_big_2.jpg" data-lightbox="image"><img alt="image 2" src="img/portfolio_2.jpg"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="img/portfolio_big_3.jpg" data-lightbox="image"><img alt="image 3" src="img/portfolio_3.jpg"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-4">
                                    <a href="img/portfolio_big_4.jpg" data-lightbox="image"><img alt="image 4" src="img/portfolio_4.jpg"></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-md-8">
                                    <a href="img/portfolio_big_5.jpg" data-lightbox="image"><img alt="image 5" src="img/portfolio_5.jpg"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tabs-content">
                        <div class="wrapper">
                            <ul class="tabs clearfix" data-tabgroup="first-tab-group">
                              <li><a class="active" href="#tab1">July 2018</a></li>
            ...
            <section class="content-section" id="contact">
                <div id="map">
                    ...
                    -->
                    <iframe width="100%" height="400px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1197183.8373802372!2d-1.9415093691103689!3d6.781986417238027!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdb96f349e85efd%3A0xb8d1e0b88af1f0f5!2sKumasi+Central+Market!5e0!3m2!1sen!2sth!4v1532967884907" frameborder="0" allowfullscreen="" style="border:0"></iframe>
                </div>
                    ...
                    <div class="section-content">
                        <form id="contact" action="#" method="post">
                            <div class="row">
                                <div class="col-md-4">
                                  <fieldset>
                                    <input name="name" class="form-control" id="name" required="" type="text" placeholder="Your name...">
                                  </fieldset>
                                </div>
                                <div class="col-md-4">
                                  <fieldset>
                                    <input name="email" class="form-control" id="email" required="" type="email" placeholder="Your email...">
                                  </fieldset>
                                </div>
                                 <div class="col-md-4">
                                  <fieldset>
                                    <input name="subject" class="form-control" id="subject" required="" type="text" placeholder="Subject...">
                                  </fieldset>
                                </div>
                                <div class="col-md-12">
                                  <fieldset>
                                    <textarea name="message" class="form-control" id="message" required="" placeholder="Your message..." rows="6"></textarea>
                                  </fieldset>
                                </div>
                                <div class="col-md-12">
                                  <fieldset>
                                    <button class="btn" id="form-submit" type="submit">Send Message Now</button>
                                  </fieldset>
                                </div>
                            </div>
                        </form>
            ...
            <section class="footer">
                <p>Copyright © 2018. Design: <a href="http://templatemo.com/tm-518-sentra" target="_blank">Sentra</a> | Distribution: <a href="https://themewagon.com" target="_blank">ThemeWagon</a></p>
            </section>
        </div>
...
<div class="lightboxOverlay" id="lightboxOverlay" style="display: none;"></div>
...
<a class="lb-next" href=""></a></div><div class="lb-loader">
<a class="lb-cancel"></a></div></div></div><div class="lb-dataContainer">
<div class="lb-data"><div class="lb-details">
