...
<body>
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a
						href="${pageContext.request.contextPath}/project_write.do"> <i
							class="menu-icon fa fa-tasks"></i>new Project
					</a></li>
					<li><a
						href="${pageContext.request.contextPath}/project_list.do"> <i
							class="menu-icon fa fa-tasks"></i>Project list
					</a></li>
					<c:if test="${sessionScope.login_result != null}">
						<li class="menu-title"><span class="ti-user">${login_result.mName}님
								환영합니다!</span></li>
						<!-- /.menu-title -->
	...
	<div id="right-panel" class="right-panel">
		...
		<header id="header" class="header">
			...
			<!-- 상단 오른쪽 // 로그인 하기전 join버튼 // 로그인 하면 사람모양-->
			<div class="header-menu">
				<div class="user-area dropdown float-right">

					<c:if test="${sessionScope.login_result == null}">
						<button type="button" class="btn btn-outline-primary"
							onclick="location.href='${pageContext.request.contextPath}/member_join.do'">Join</button>
					</c:if>
				</div>
			</div>
		</header>
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header">
						<strong>Insert Project</strong>
					</div>
					<div class="card-body card-block">
						<form action="project_write.ing" method="post"
							class="form-horizontal">
							<div class="row form-group">
								<div class="col col-md-3">
									<label for="text-input" class=" form-control-label">Project
										Title</label>
								</div>
								<div class="col-12 col-md-9">
									<input type="hidden" name="mId" value="${login_result.mId}">
									<input type="text" name="bTitle" placeholder="프로젝트명"
										class="form-control">
								</div>
							</div>
							<div class="row form-group">
								<div class="col-lg-3">
									<label for="text-input" class=" form-control-label">Start
										Date</label>
								</div>
								<div class="col-lg-3">
									<input type="date" name="bStart_date" class="form-control">
								</div>

								<div class="col-lg-3">
									<label for="text-input" class=" form-control-label">End
										Date</label>
								</div>
								<div class="col-lg-3">
									<input type="date" name="bEnd_date" id="bEnd_date"
										class="form-control">
								</div>
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<textarea name="bContent" rows="9" placeholder="Content..."
										class="form-control"></textarea>
								</div>
							</div>

							<div class="row form-group">
								<label class="col col-md-3">진행률</label>
								<progress id="progressBar" value="0.0" max="1"></progress>
								<input type="text" name="bPercent" id="myvalue" value="0" />
		...
		<footer class="site-footer">
			<div class="footer-inner bg-white">
				<div class="row">
					<div class="col-sm-6">Copyright &copy; 2019진도관리프로그램</div>
	...
	<script
		src="<c:url value='/resources/assets/js/init/weather-init.js'/>"></script>

	<script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
	<script
		src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
	<script
		src="<c:url value='/resources/assets/js/init/fullcalendar-init.js'/>"></script>
